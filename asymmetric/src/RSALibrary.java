...
public class RSALibrary {
  ...
  public static void generateKeys() throws IOException {
    ...
    try {
	  ...
	  // ...
    X509EncodedKeySpec pubKey = new X509EncodedKeySpec(keys.getPublic().getEncoded());
    ...
    fos.close();
	  ...
	  // ...
    PKCS8EncodedKeySpec privKey = new PKCS8EncodedKeySpec(keys.getPrivate().getEncoded());
